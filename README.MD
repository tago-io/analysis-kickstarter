...
* **Make sure you change the account_token** within all the analysis enviornment variables otherwise the analysis won't create the devices in the correct profile. 
