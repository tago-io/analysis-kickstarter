...
export function ThermometerIcon() {
  // 24×24 viewBox with padding so the outline never clips. The shape is one
  // continuous outline: stem with rounded cap on top, flares into a single
  // round bulb at the bottom. The mercury fill is a smaller capsule + bulb
  // drawn inside, with breathing room so it never touches the outline.
  return (
